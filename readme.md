...
This is just a super simple CLI utilizing [CryptoCompare API](https://www.cryptocompare.com/api/) to grab the ETH price during the midst of some serious code sessions.

![demo](http://g.recordit.co/s3jTAcrB1u.gif)
